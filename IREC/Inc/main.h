...
/* Private defines -----------------------------------------------------------*/
#define LPS25HB_SCL_Pin GPIO_PIN_10
#define LPS25HB_SCL_GPIO_Port GPIOB
#define LPS25HB_SDA_Pin GPIO_PIN_11
#define LPS25HB_SDA_GPIO_Port GPIOB
...
#define BMP280_SCL_Pin GPIO_PIN_8
#define BMP280_SCL_GPIO_Port GPIOB
#define BMP280_SDA_Pin GPIO_PIN_9
