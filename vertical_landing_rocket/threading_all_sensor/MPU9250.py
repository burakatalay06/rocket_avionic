...
class MPU9250:
    ...
    __AK8963_I2C_ADDR             = 0x18 #0x0c 0x18
    ...
    def __init__(self, spi_bus_number = 0, spi_dev_number = 0):
...
# -----------------------------------------------------------------------------------------------
    ...
    def calib_acc(self):
        ...
        self.calib_data[0] = ((response[0] & 11100000) >> 3) | ((response[3] & 10110000) >> 4)
        self.calib_data[1] = ((response[1] & 11100000) >> 3) | ((response[3] & 10001100) >> 2)
        self.calib_data[2] = ((response[2] & 11100000) >> 3) | ((response[3] & 10000011))
